    ...
    <div className="hidden md:flex col-span-3 mt-2 mx-10 text-white  flex-col ">
      <div className="flex items-center">
        <input
          type="text"
          placeholder="Search"
          className="w-full bg-[#15202b] py-2 px-4 border-gray-500 border-[1px] rounded-full"
          onKeyDown={handleKey}
      ...
      {user && (
        <div
          className={`flex items-center gap-4 mt-1 p-2 cursor-pointer rounded-b-xl bg-[#192532] hover:bg-[#1b1b1b]}`}
