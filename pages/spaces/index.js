...
function Spaces() {
  ...
  return (
    <div className="bg-[#15202b] text-white h-screen flex">
      <Head>
        <title>Spaces - COER-FORUMS</title>
      ...
      <main className="grid grid-cols-10">
        ...
        <div className="min-w-fit col-span-8 w-full overflow-y-scroll scrollbar-thin scrollbar-thumb-[#1f1f1f]">
          {/* HEADER */}
          <div className="sticky flex items-center bg-[#15202b] top-0 z-1000 py-4 px-5 border-b font-bold text-white text-xl gap-x-4">
            <div
          ...
          <div className="border bg-[#15202b] m-5 rounded-xl p-2 w-[75%]">
